...
var TimeGridEventRenderer = /** @class */ (function (_super) {
    ...
    TimeGridEventRenderer.prototype.renderSegs = function (
        context,
        segs,
        mirrorInfo
    ) {
    ...
    TimeGridEventRenderer.prototype.renderSegHtml = function (seg, mirrorInfo) {
        ...
        var isDraggable = computeEventDraggable(
            this.context,
            eventDef,
            eventUi
        );
        var isResizableFromStart =
            seg.isStart &&
            computeEventStartResizable(this.context, eventDef, eventUi);
        var isResizableFromEnd =
            seg.isEnd &&
            computeEventEndResizable(this.context, eventDef, eventUi);
...
var TimeGrid = /** @class */ (function (_super) {
    ...
    function TimeGrid(el, renderProps) {
        ...
        _this.renderSlats = memoizeRendering(_this._renderSlats, null, [
            _this.renderSkeleton,
        ]);
        _this.renderColumns = memoizeRendering(
    ...
    TimeGrid.prototype.renderContentSkeleton = function () {
        ...
        this.mirrorContainerEls = findElements(
            skeletonEl,
            ".fc-mirror-container"
        );
...
var AbstractTimeGridView = /** @class */ (function (_super) {
    ...
    AbstractTimeGridView.prototype._renderSkeleton = function (context) {
        ...
        if (context.options.allDaySlot) {
            ...
            this.dayGrid = new DayGrid(this.el.querySelector(".fc-day-grid"), {
    ...
    /* Dimensions
    ------------------------------------------------------------------------------------------------------------------*/
    AbstractTimeGridView.prototype.updateSize = function (
        isResize,
        viewHeight,
        isAuto
    ) {
    ...
    AbstractTimeGridView.prototype.updateBaseSize = function (
        isResize,
        viewHeight,
        isAuto
    ) {
    ...
    AbstractTimeGridView.prototype.computeScrollerHeight = function (
        viewHeight
    ) {
