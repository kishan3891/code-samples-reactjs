    ...
    */
    var TimeGridEventRenderer = /** @class */ (function (_super) {
        ...
        TimeGridEventRenderer.prototype.renderSegHtml = function (
            ...
            var isDraggable = core.computeEventDraggable(
                this.context,
                eventDef,
                eventUi
            );
            var isResizableFromStart =
                seg.isStart &&
                core.computeEventStartResizable(
                    this.context,
                    eventDef,
                    eventUi
                );
            var isResizableFromEnd =
                seg.isEnd &&
                core.computeEventEndResizable(this.context, eventDef, eventUi);
    ...
    var TimeGrid = /** @class */ (function (_super) {
        ...
        function TimeGrid(el, renderProps) {
            ...
            _this.renderSlats = core.memoizeRendering(
                _this._renderSlats,
                null,
                [_this.renderSkeleton]
            );
            _this.renderColumns = core.memoizeRendering(
    ...
    var AbstractTimeGridView = /** @class */ (function (_super) {
        ...
        function AbstractTimeGridView() {
            ...
            _this.renderSkeleton = core.memoizeRendering(
    ...
    var TimeGridView = /** @class */ (function (_super) {
        ...
        TimeGridView.prototype._renderSkeleton = function (context) {
            ...
            if (context.options.columnHeader) {
                this.header = new core.DayHeader(
