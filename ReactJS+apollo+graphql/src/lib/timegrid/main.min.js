...
!(function (e, t) {
        ...
        s = (function (e) {
            ...
            return (
                ...
                (r.prototype.renderSegs = function (r, i, n) {
                    e.prototype.renderSegs.call(this, r, i, n),
                        (this.fullTimeFormat = t.createFormatter({
                            hour: "numeric",
                            minute: "2-digit",
                            separator: this.context.options
                ...
                (r.prototype.computeSegSizes = function (e) {
                    ...
                    if ((t.computeSegVerticals(e), r))
                        for (var n = 0; n < i; n++)
                            this.computeSegHorizontals(r[n]);
                }),
                ...
                (r.prototype.renderSegHtml = function (e, r) {
                    var i,
                        ...
                        h =
                            e.isStart &&
                            t.computeEventStartResizable(this.context, a, l),
                        u =
                            e.isEnd &&
                            t.computeEventEndResizable(this.context, a, l),
                        p = this.getSegClasses(e, c, h || u, r),
                        f = t.cssToStr(this.getSkinCss(l));
                    if (
                        (p.unshift("fc-time-grid-event"),
                        t.isMultiDayRange(s.range))
                    ) {
                        if (e.isStart || e.isEnd) {
                            var g = e.start,
                                m = e.end;
                            (i = this._getTimeText(g, m, d)),
                                (n = this._getTimeText(
                                    g,
                                    m,
                                    d,
                                ...
                                (o = this._getTimeText(g, m, d, null, !1));
                        }
                    } else
                        (i = this.getTimeText(s)),
                ...
                (r.prototype.assignSegCss = function (e) {
                    for (var r = 0, i = e; r < i.length; r++) {
                        ...
                        t.applyStyle(n.el, this.generateSegCss(n)),
                            n.level > 0 &&
                                n.el.classList.add("fc-time-grid-event-inset"),
    ...
    function l(e, t, r) {
        ...
        for (var i = 0; i < t.length; i++)
            (n = e),
                (o = t[i]),
                n.bottom > o.top && n.top < o.bottom && r.push(t[i]);
        var n, o;
        return r;
    }
    function d(e) {
    ...
    var c = (function (e) {
        ...
        p = (function (e) {
            function i(r, i) {
                ...
                (n.isSlatSizesDirty = !1),
                    ...
                    (n.renderSlats = t.memoizeRendering(n._renderSlats, null, [
                        n.renderSkeleton,
                    ])),
                    (n.renderColumns = t.memoizeRendering(
                        n._renderColumns,
                        n._unrenderColumns,
                        [n.renderSkeleton]
                    )),
                ...
                return (
                    ...
                    (n.renderBusinessHours = t.memoizeRendering(
                        l.renderSegs.bind(l, "businessHours"),
                        l.unrender.bind(l, "businessHours"),
                        [o]
                    )),
                    (n.renderDateSelection = t.memoizeRendering(
                        n._renderDateSelection,
                        n._unrenderDateSelection,
                        [o]
                    )),
                    (n.renderFgEvents = t.memoizeRendering(
                        a.renderSegs.bind(a),
                        a.unrender.bind(a),
                        [o]
                    )),
                    (n.renderBgEvents = t.memoizeRendering(
                        l.renderSegs.bind(l, "bgEvent"),
                        l.unrender.bind(l, "bgEvent"),
                        [o]
                    )),
                    (n.renderEventSelection = t.memoizeRendering(
                        a.selectByInstanceId.bind(a),
                        a.unselectByInstanceId.bind(a),
                        [n.renderFgEvents]
                    )),
                    (n.renderEventDrag = t.memoizeRendering(
                        n._renderEventDrag,
                        n._unrenderEventDrag,
                        [o]
                    )),
                    (n.renderEventResize = t.memoizeRendering(
            ...
            return (
                ...
                (i.prototype._processOptions = function (e) {
                    ...
                    (n = t.createDuration(n)),
                        ...
                        null === (r = t.wholeDivideDurations(n, o)) &&
                            ((o = n), (r = 1)),
                        (this.slotDuration = n),
                        (this.snapDuration = o),
                        (this.snapsPerSlot = r),
                ...
                (i.prototype.computeLabelInterval = function (e) {
                    ...
                    for (r = u.length - 1; r >= 0; r--)
                        if (
                            ...
                            null !== (n = t.wholeDivideDurations(i, e)) &&
                                n > 1)
                        )
                            return i;
                    return e;
                ...
                (i.prototype.renderSlatRowHtml = function (e) {
                    for (
                        var r,
                            ...
                            l = o.isRtl,
                            d = "",
                            c = t.startOfDay(e.renderRange.start),
                            h = e.minTime,
                            u = t.createDuration(0);
                        t.asRoughMs(h) < t.asRoughMs(e.maxTime);

                    )
                        (r = s.add(c, h)),
                            (i =
                                null !==
                                t.wholeDivideDurations(u, this.labelInterval)),
                            (n =
                ...
                (i.prototype._renderColumns = function (e, i) {
                    ...
                    for (var h = 0; h < this.colCnt; h++)
                        o.publiclyTrigger("dayRender", [
                            {
                                date: d.toDate(e[h].date),
                                el: this.colEls[h],
                                view: s,
                            },
                        ]);
                ...
                (i.prototype.renderContentSkeleton = function () {
                    ...
                    r && i.reverse(),
                        (e = this.contentSkeletonEl = t.htmlToElement(
                            '<div class="fc-content-skeleton"><table><tr>' +
                                i.join("") +
                                "</tr></table></div>"
                        )),
                        (this.colContainerEls = t.findElements(
                            e,
                            ".fc-content-col"
                        )),
                        ...
                        (this.bgContainerEls = t.findElements(
                            e,
                ...
                (i.prototype.attachSegsByCol = function (e, t) {
                    ...
                    for (r = 0; r < this.colCnt; r++)
                        for (i = e[r], n = 0; n < i.length; n++)
                            t[r].appendChild(i[n].el);
                }),
                ...
                (i.prototype.computeDateTop = function (e, r) {
                    return (
                        r || (r = t.startOfDay(e)),
                        this.computeTimeTop(
                            t.createDuration(e.valueOf() - r.valueOf())
                        )
                    );
                }),
                (i.prototype.computeTimeTop = function (e) {
                    ...
                    return (
                        ...
                        this.slatPositions.tops[r] +
                            this.slatPositions.getHeight(r) * i
                    );
                }),
                ...
                (i.prototype.assignSegVerticals = function (e) {
                    ...
                    for (r = 0; r < e.length; r++)
                        (i = e[r]),
                            t.applyStyle(i.el, this.generateSegVerticalCss(i));
                }),
        ...
        m = (function (e) {
            function i() {
                ...
                return (
                    (r.splitter = new f()),
                    (r.renderSkeleton = t.memoizeRendering(
                        r._renderSkeleton,
                        r._unrenderSkeleton
                    )),
                    ...
                    (r.renderTimeGridBgIntroHtml = function () {
                        return (
                            '<td class="fc-axis ' +
                            r.context.theme.getClass("widgetContent") +
                            '" ' +
                            r.axisStyleAttr() +
                            "></td>"
                        );
            ...
            return (
                ...
                (i.prototype._renderSkeleton = function (e) {
                    this.el.classList.add("fc-timeGrid-view"),
                        ...
                        (this.scroller = new t.ScrollComponent(
                            "hidden",
                            "auto"
                        ));
                    var i = this.scroller.el;
                    this.el.querySelector(".fc-body > tr > td").appendChild(i),
                        i.classList.add("fc-time-grid-container");
                    var n = t.createElement("div", {
                        className: "fc-time-grid",
                    });
                    if (
                        (i.appendChild(n),
                        (this.timeGrid = new p(n, {
                            renderBgIntroHtml: this.renderTimeGridBgIntroHtml,
                            renderIntroHtml: this.renderTimeGridIntroHtml,
                        })),
                        e.options.allDaySlot)
                    ) {
                        this.dayGrid = new r.DayGrid(
                            this.el.querySelector(".fc-day-grid"),
                            {
                                renderNumberIntroHtml: this
                                    .renderDayGridIntroHtml,
                                renderBgIntroHtml: this
                    ...
                    if (
                        ...
                        (this.timeGrid.bottomRuleEl.style.display = "none"),
                            ...
                            this.dayGrid &&
                                ...
                                (n = this.context.options.eventLimit) &&
                                    "number" != typeof n &&
                                    (n = 5),
            ...
            return (
                ...
                (i.prototype.render = function (t, r) {
                    ...
                    this.header &&
                        ...
                        this.simpleTimeGrid.receiveProps(
                            o({}, d.timed, { dateProfile: n, dayTable: l }),
                            r
                        ),
                        this.simpleDayGrid &&
                ...
                (i.prototype._renderSkeleton = function (i) {
                    e.prototype._renderSkeleton.call(this, i),
                        i.options.columnHeader &&
                            (this.header = new t.DayHeader(
                                this.el.querySelector(".fc-head-container")
                            )),
                        (this.simpleTimeGrid = new y(this.timeGrid)),
                        this.dayGrid &&
                            (this.simpleDayGrid = new r.SimpleDayGrid(
                                this.dayGrid
                            ));
                }),
                (i.prototype._unrenderSkeleton = function () {
